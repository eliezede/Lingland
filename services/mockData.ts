...
const DEFAULT_RATES: Rate[] = [
  { id: 'r1', type: 'CLIENT_CHARGE', serviceType: ServiceType.FACE_TO_FACE, unitType: 'HOUR', amountPerUnit: 45.00, minimumUnits: 1, roundingIncrementMinutes: 15, currency: 'GBP' },
  { id: 'r2', type: 'CLIENT_CHARGE', serviceType: ServiceType.VIDEO, unitType: 'HOUR', amountPerUnit: 40.00, minimumUnits: 1, roundingIncrementMinutes: 15, currency: 'GBP' },
  { id: 'r3', type: 'INTERPRETER_PAY', serviceType: ServiceType.FACE_TO_FACE, unitType: 'HOUR', amountPerUnit: 25.00, minimumUnits: 1, roundingIncrementMinutes: 15, currency: 'GBP' },
  { id: 'r4', type: 'INTERPRETER_PAY', serviceType: ServiceType.VIDEO, unitType: 'HOUR', amountPerUnit: 22.00, minimumUnits: 1, roundingIncrementMinutes: 15, currency: 'GBP' }
];

// Dynamic timesheet for "Yesterday" booking b2
