    ...
    <div className="space-y-5">
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
          <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-xl font-black text-slate-950 dark:text-white">{invoice.interpreterName}</h2>
              <p className="mt-1 text-sm font-medium text-slate-500 dark:text-slate-400">
            ...
            <div className="text-left md:text-right">
              ...
              <p className="mt-1 text-sm font-semibold text-slate-500 dark:text-slate-400">Model {invoice.model.replace('_', ' ')}</p>
            </div>
          </div>
        </div>
      ...
      <section className="overflow-hidden rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-[820px] w-full divide-y divide-slate-200 dark:divide-slate-800">
