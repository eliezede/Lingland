       ...
       <div className="flex items-center justify-between">
        ...
        <div className="space-x-3">
           {invoice.status === InvoiceStatus.SUBMITTED && (
             <>
               <button onClick={() => handleStatusUpdate(InvoiceStatus.REJECTED)} className="px-4 py-2 border border-red-300 text-red-700 rounded-lg text-sm font-medium hover:bg-red-50 flex items-center inline-flex">
                 <XCircle size={16} className="mr-2" /> Reject
               </button>
               <button onClick={() => handleStatusUpdate(InvoiceStatus.APPROVED)} className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 flex items-center inline-flex">
