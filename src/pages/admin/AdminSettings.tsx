...
import { 
  ...
  Check, Globe2, AlertCircle, ShieldCheck, UserCog 
} from 'lucide-react';
import { AdminUsers } from './AdminUsers';

type Tab = 'GENERAL' | 'FINANCE' | 'OPERATIONS' | 'MASTER_DATA' | 'USERS';
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            {activeTab === 'USERS' ? 'Manage authentication, roles, and linked profiles.' : 'Global configuration for the Lingland platform.'}
          </p>
        </div>
        {activeTab !== 'USERS' && (
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="flex border-b border-gray-100 overflow-x-auto scrollbar-hide">
          ...
          <TabButton id="USERS" label="Users" icon={UserCog} />
        </div>
