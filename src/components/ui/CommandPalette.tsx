...
export const CommandPalette = () => {
    ...
    const commands: CommandItem[] = [
        ...
        // Finance
        { id: 'accounts-receivable', title: 'Accounts Receivable', subtitle: 'Client billing and collections workspace', icon: PoundSterling, category: 'Finance', keywords: ['finance', 'accounts', 'billing', 'clients', 'receivables'], onSelect: () => navigate('/admin/finance/receivables') },
        { id: 'ready-client-invoice', title: 'Ready to Invoice', subtitle: 'Client invoice preparation batches', icon: PoundSterling, category: 'Finance', keywords: ['invoice ready', 'client invoice', 'accounts receivable'], onSelect: () => navigate('/admin/finance/receivables?queue=READY') },
        { id: 'awaiting-payment', title: 'Awaiting Payment', subtitle: 'Issued client invoices waiting for payment', icon: PoundSterling, category: 'Finance', keywords: ['paid', 'payment', 'outstanding', 'receivables'], onSelect: () => navigate('/admin/finance/receivables?queue=ISSUED') },
        { id: 'interpreter-payables', title: 'Interpreting Payables', subtitle: 'Monthly interpreter settlement cycles', icon: PoundSterling, category: 'Finance', keywords: ['payments', 'remittance', 'interpreters', 'timesheets'], onSelect: () => navigate('/admin/finance/payables/interpreting') },
        { id: 'translation-payables', title: 'Translation Payables', subtitle: 'Monthly translator settlement cycles', icon: FileText, category: 'Finance', keywords: ['payments', 'remittance', 'translations', 'translators'], onSelect: () => navigate('/admin/finance/payables/translations') },
